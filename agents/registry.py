...
class AgentRegistry:
    ...
    def get(self, name: str) -> Any:
        """Retrieve an instance of an agent by its registered name, raising KeyError if missing."""
...
def get_agent(name: str) -> Any:
    """Compatibility helper to get an agent instance from the global registry."""
