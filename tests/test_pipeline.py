...
def test_pipeline_run_string(pipeline):
    """Test executing a pipeline via string description."""
    result = pipeline.run("agent_a -> agent_b", "hello")
    assert result.success is True
    assert "Processed by agent_b" in result.content
