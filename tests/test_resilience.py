...
def test_research_agent_handles_rate_limit_error(mock_anthropic):
...
@patch("agents.research.anthropic.Anthropic")
def test_research_agent_handles_api_connection_error(mock_anthropic):
...
@patch("agents.research.anthropic.Anthropic")
def test_research_agent_handles_overloaded_error(mock_anthropic):
...
@patch("agents.research.anthropic.Anthropic")
def test_research_agent_handles_malformed_response(mock_anthropic):
