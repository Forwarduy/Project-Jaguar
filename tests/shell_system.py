...
def test_shell_system_run_and_chain():
    ...
    # Find a valid registered agent name dynamically
    agents_list = list(AGENT_REGISTRY.keys())
    if agents_list:
...
def test_shell_system_base_agent_methods():
    ...
    assert bad_res.success is True  # Falls back gracefully or handled via execute wrapper
