...
class MockAgent(BaseAgent):
    ...
    run()/execute() aceptan cualquier kwarg de "contenido" (topic, goal,
    target, prompt) para poder representar a cualquiera de los 3 agentes
    reales, que cada uno nombra su parámetro distinto.
    """
    ...
    def execute(self, **kwargs) -> AgentResult:
        # Igual que ResearchAgent.execute(): reenvía todo por kwargs
        # (necesario para que llegue client=... sin TypeError).
