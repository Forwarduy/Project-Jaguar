...
def research_cmd(topic: str):
    ...
    # Inicializar el cliente oficial de Anthropic tomando ANTHROPIC_API_KEY del entorno
    client = anthropic.Anthropic()
    
    agent_factory = AGENT_REGISTRY.get("research")
    if agent_factory:
        # Inyectar el cliente requerido para evitar AttributeError en _call_llm_structured
